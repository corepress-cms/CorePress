		...
		<div class="about__section">
			<div class="column">
				...
				<p class="is-subheading">
					<?php _e( 'Create and deploy beautiful and coherent design elements across your sites with CorePress 6.6. A new rollback option for auto-updating plugins gives you control, flexibility, and peace of mind.' ); ?>
				</p>
			</div>
		</div>
